...
<form name="paytofenform" method="post" action="pay.php">
  <table width="500" border="0" align="center" cellpadding="3" cellspacing="1" class="table table-bordered table-striped">
    <tr class="header"> 
      ...
      <input class="input input-auto" type="hidden" name="phome" value="PayToFen"></td>
    </tr>
    <tr> 
      <td width="127" height="25" bgcolor="#FFFFFF">购买金额：</td>
      <td width="358" bgcolor="#FFFFFF"> <input class="input input-auto" name="money" type="text" value="" size="8" onchange="ChangeShowBuyFen(document.paytofenform.money.value);">
    ...
    <tr> 
      ...
      <td height="25" bgcolor="#FFFFFF"><select class="input input-auto" name="payid" style="WIDTH: 120px">
          <?=$pays?>
        </SELECT></td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF">&nbsp;</td>
      <td height="25" bgcolor="#FFFFFF"><input class="button" type="submit" name="Submit" value="确定购买"></td>
    </tr>
  </table>
</form>
<br><br>
<form name="paytomoneyform" method="post" action="pay.php">
  <table width="500" border="0" align="center" cellpadding="3" cellspacing="1" class="table table-bordered table-striped">
    <tr class="header"> 
      ...
      <input class="input input-auto" name="phome" type="hidden" id="phome" value="PayToMoney"></td>
    </tr>
    <tr> 
      <td width="127" height="25" bgcolor="#FFFFFF">金额：</td>
      <td width="358" bgcolor="#FFFFFF"> <input class="input input-auto" name="money" type="text" value="" size="8">
        元</td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF">支付平台：</td>
    ...
    <tr> 
      <td height="25" bgcolor="#FFFFFF">&nbsp;</td>
      <td height="25" bgcolor="#FFFFFF"><input class="button" type="submit" name="Submit3" value="确定支付"></td>
    </tr>
  </table>
</form>
<?php
