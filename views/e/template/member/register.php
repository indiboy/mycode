...
<table width='100%' border='0' align='center' cellpadding='3' cellspacing='1' class="table table-bordered table-striped">
  <form name=userinfoform method=post enctype="multipart/form-data" action=../doaction.php>
    <input class="input input-auto" type=hidden name=enews value=register>
    <tr class="header"> 
      <td height="25" colspan="2">注册会员<?=$tobind?' (绑定账号)':''?></td>
    </tr>
    <tr> 
      <td height="25" colspan="2"><strong>基本信息 
        <input class="input input-auto" name="groupid" type="hidden" id="groupid" value="<?=$groupid?>">
    ...
    <tr> 
      ...
      <td width='75%' height="25" bgcolor="#FFFFFF"> <input class="input input-auto" name='username' type='text' id='username' maxlength='30'>
        *</td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"> <div align='left'>密码</div></td>
      <td height="25" bgcolor="#FFFFFF"> <input class="input input-auto" name='password' type='password' id='password' maxlength='20'>
        *</td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"> <div align='left'>重复密码</div></td>
      <td height="25" bgcolor="#FFFFFF"> <input class="input input-auto" name='repassword' type='password' id='repassword' maxlength='20'>
        *</td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"> <div align='left'>邮箱</div></td>
      <td height="25" bgcolor="#FFFFFF"> <input class="input input-auto" name='email' type='text' id='email' maxlength='50'>
        *</td>
    </tr>
    <tr> 
    ...
    <tr>
      ...
      <td height="25" bgcolor="#FFFFFF"><input class="input input-auto" name="key" type="text" id="key" size="6">
    ...
    <tr> 
      ...
      <td height="25" bgcolor="#FFFFFF"> <input class="input input-auto" type='submit' name='Submit' value='马上注册'>
        &nbsp;&nbsp; <input class="input input-auto" type='button' name='Submit2' value='返回' onclick='history.go(-1)'></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
