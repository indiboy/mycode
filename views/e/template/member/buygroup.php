...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="table table-bordered table-striped">
  ...
  ?>
    <tr bgcolor="#FFFFFF"> 
      <td height="25"><table width="100%" border="0" cellspacing="1" cellpadding="3">
          <tr> 
            <td width="1%"> <input class="input input-auto" type="radio" name="id" value="<?=$r[id]?>">
            </td>
            <td width="97%"> 
              <?=$r[gmoney]?>
              元 （ 
  ...
  ?>
    <tr bgcolor="#FFFFFF">
      <td height="25">支付平台：
        <select class="input input-auto" name="payid" style="WIDTH: 120px">
          <?=$pays?>
        </SELECT></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td height="25"><input class="button" type="submit" name="Submit" value="马上充值">
        &nbsp;&nbsp; <input class="input input-auto" type="button" name="Submit2" value="返回" onclick="self.location.href='../../../';">
      </td>
    </tr>
  </form>
</table>
