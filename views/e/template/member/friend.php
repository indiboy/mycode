...
?>
          ...
          <form name="form1" method="post" action="">
            <tr> 
              <td width="50%" height="30" bgcolor="#FFFFFF">选择分类: 
                <select class="input input-auto" name="cid" id="select" onchange=window.location='../friend/?cid='+this.options[this.selectedIndex].value>
        ...
        <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table table-bordered table-striped">
          <form name=favaform method=post action="../doaction.php" onsubmit="return confirm('确认要操作?');">
            <input class="input input-auto" type=hidden value=hy name=enews>
            <tr class="header"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td> <div align="center"> 
                  <input class="input input-auto" name="fsay[]" type="text" id="fsay[]" value="<?=stripSlashes($r[fsay])?>" size="32">
                </div></td>
