...
$ecms_config['db']['dbserver']='4xf7nzw4.2287.dnstoo.com';	//数据库登录地址
$ecms_config['db']['dbport']='5512';	//端口，不填为按默认
$ecms_config['db']['dbusername']='nhr82q_f';	//数据库用户名
$ecms_config['db']['dbpassword']='xr3g72gt';	//数据库密码
$ecms_config['db']['dbname']='nhr82q';	//数据库名
...
$ecms_config['esafe']['ecookiernd']='9VH5LRopNoATcJo1Gr78f8fKp6pUvC';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='gkrgq';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='htmll';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='gI1qw0M8jUqSSM6hWjp9gJpN5V286M';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='7gnJQrIa93BYAC2vJe11ZJ9hClzwcC';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'e6yMTEiIRCPJjuRRMVZU4KkLmxbR0r',
